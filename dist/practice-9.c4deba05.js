...
class LinearRegression {
    ...
    // Methods
    getAverage(name) {
        return name == "y" ? this.#y.reduce((state, curr)=>state + curr
    ...
    getS(data = "x") {
        return Math.sqrt(1 / this[`${data}`].length * this[`${data}`].reduce((state, current)=>{
            return state + Math.pow(current - this[`getAverage${data.toUpperCase()}`](), 2);
        }, 0));
    }
}
...
},{}],"bWuwh":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
//# sourceMappingURL=practice-9.c4deba05.js.map
